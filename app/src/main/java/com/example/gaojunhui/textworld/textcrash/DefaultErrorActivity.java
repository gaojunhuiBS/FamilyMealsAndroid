...
package com.example.gaojunhui.textworld.textcrash;
...
public final class DefaultErrorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (restartActivityClass != null) {
            ...
            restartButton.setOnClickListener(v -> CustomActivityOnCrash.closeApplication(DefaultErrorActivity.this, eventListener));
        }

        Button moreInfoButton = (Button) findViewById(R.id.customactivityoncrash_error_activity_more_info_button);
        if (UIUtil.isApkDebugable(getApplicationContext())&&CustomActivityOnCrash.isShowErrorDetailsFromIntent(getIntent())) {
