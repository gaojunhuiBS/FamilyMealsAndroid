...
import com.example.gaojunhui.textworld.myapplication.BaseApplication;
import java.io.File;
...
public class ProgressMActivity extends AppCompatActivity implements View.OnClickListener {
    private static final String TAG = "ProgressMActivity";
    // github 服务器可能下载不稳定
    ...
    private void initView() {
        setContentView(R.layout.activity_progress_m);
