package com.example.gaojunhui.textworld.progressmanager.weight;

import android.os.Handler;
import android.os.Looper;
import com.example.gaojunhui.textworld.progressmanager.weight.body.ProgressRequestBody;
import com.example.gaojunhui.textworld.progressmanager.weight.body.ProgressResponseBody;
...
public final class ProgressManager {
     ...
     * 如已使用 {@link me.jessyan.progressmanager.ProgressManager#with(OkHttpClient.Builder)},就不会用到此方法
     * @param response
     * @return
     */
